...
<a href="#-the-idea">
  <img src="https://img.shields.io/badge/01-THE%20IDEA-E85B4A?style=for-the-badge&labelColor=252525" alt="The Idea">
</a>
<a href="#-how-it-works">
  <img src="https://img.shields.io/badge/02-HOW%20IT%20WORKS-A8D790?style=for-the-badge&labelColor=252525" alt="How it works">
</a>
<a href="#-architecture">
  <img src="https://img.shields.io/badge/03-ARCHITECTURE-F7F5F2?style=for-the-badge&labelColor=252525" alt="Architecture">
</a>

<br><br>

<img src="./assets/hero.png" width="900" alt="Atsumaru — Meet people, not profiles">
...
<p>
<img src="https://img.shields.io/badge/HIKING-E85B4A?style=flat-square">
<img src="https://img.shields.io/badge/COFFEE-E85B4A?style=flat-square">
<img src="https://img.shields.io/badge/BOARD%20GAMES-E85B4A?style=flat-square">
<img src="https://img.shields.io/badge/CHILL-252525?style=flat-square">
<img src="https://img.shields.io/badge/EXPLORER-252525?style=flat-square">
</p>
...
flowchart LR
    ...
    A["AI conversation"] --> B["Interest + personality extraction"]
    B --> C["MiniLM embedding"]
    C --> D[("Supabase pgvector")]

    D --> E["Group matching"]

    E --> F["Preference similarity"]
    E --> G["Group balance"]
    E --> H["Reputation"]
...
sequenceDiagram
    ...
    participant API as Atsumaru API
    participant Provider as Google / LINE
    participant Supabase as Supabase Auth

    App->>API: Start OAuth
    API->>Provider: Authorization
    Provider->>API: OAuth callback
    API->>Supabase: Verify / exchange
    Supabase-->>API: Session
    API-->>App: One-time auth code
