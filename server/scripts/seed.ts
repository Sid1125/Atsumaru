...
const EVENTS: DemoEvent[] = [
  ...
  },
  {
    ...
    offset: { lat: 0.008, lng: 0.001 },
    startsInHours: 48,
    max_size: 6,
    host: "mikaplays",
    members: ["mikaplays", "linlens", "harucafe"],
  },
  {
    ...
    offset: { lat: 0.001, lng: 0.008 },
    startsInHours: 72,
    max_size: 6,
    host: "harucafe",
    members: ["harucafe", "sotaruns", "mikaplays"],
  },
  {
    ...
    offset: { lat: -0.009, lng: -0.002 },
    startsInHours: 96,
    max_size: 6,
    host: "linlens",
    members: ["linlens", "ramenkenji", "trailbrew"],
  },
  {
    ...
    offset: { lat: 0.003, lng: -0.009 },
    startsInHours: 120,
    max_size: 6,
    host: "sotaruns",
    members: ["sotaruns", "harucafe", "linlens", "mikaplays"],
  },
  {
    ...
    offset: { lat: -0.002, lng: 0.009 },
    startsInHours: 144,
    max_size: 6,
    host: "ramenkenji",
    members: ["ramenkenji", "sotaruns", "trailbrew"],
  },
];
